...
#pragma once
#ifndef __SIMPLEFILTERTESTER_H
#define __SIMPLEFILTERTESTER_H
...
class CSimpleFilterTester : public CPlugIn
{
public:
	...
	virtual ~CSimpleFilterTester(void);
	...
	CBiQuad leftChannel;
	CBiQuad rightChannel;
	void firstOrderLPF(float freq);
	void secondOrderLPF(float freq, float qValue);
	void secondOrderBWLPF(float freq);
	void secondOrderLRLPF(float freq);
	void secondOrderMassbergLPF(float freq, float qValue);
